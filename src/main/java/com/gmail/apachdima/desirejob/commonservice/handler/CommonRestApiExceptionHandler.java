package com.gmail.apachdima.desirejob.commonservice.handler;
...
@ControllerAdvice
@Slf4j
public class CommonRestApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
        ...
        String supportedMethods = Objects.nonNull(ex.getSupportedHttpMethods())
            ? ex.getSupportedHttpMethods().stream().map(Enum::name).collect(Collectors.joining(CommonConstant.SPACE.getValue()))
